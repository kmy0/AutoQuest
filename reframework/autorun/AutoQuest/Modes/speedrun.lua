                ...
                if (
                    ...
                    if dump.quest_data_list[config.current.auto_quest.quest_no] then
                        ...
                        if config.current.auto_quest.use_legacy then
                            ...
                            singletons.quest_counter = sdk.create_instance('snow.gui.fsm.questcounter.GuiQuestCounterFsmManager'):add_ref()
    ...
    sdk.hook(methods.quest_board_top_start,function(args)end,
        function()
            if (
                ...
                methods.quest_board_decide_quick:call(
                    singletons.quest_board,
                    0,
                    1
                )
            end
