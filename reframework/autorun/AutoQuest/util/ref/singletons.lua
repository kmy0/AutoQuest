...
local types = require("AutoQuest.util.ref.types")
...
---@param singleton `T`
---@return T
function this.get_no_cache(singleton)
    return sdk.get_managed_singleton(singleton) --[[@as snow.SnowSingletonBehaviorRoot]]
end
